...
htmlhelp_basename = 'NCCSCoreFilesdoc'
...
latex_documents = [
    (master_doc, 'NCCSCoreFiles.tex', 'NCCS Core Files Documentation',
     'Jeff Levy', 'manual'),
]
...
man_pages = [
    (master_doc, 'nccscorefiles', 'NCCS Core Files Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'NCCSCoreFiles', 'NCCS Core Files Documentation',
     author, 'NCCSCoreFiles', 'One line description of project.',
     'Miscellaneous'),
]
